...
@section("title","Tambah Laporan - " . $training_center->name)
@section('breadcrumb')
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">
                    <i class="fas fa-chart-bar"></i> Input Performa Pelatihan
                </h3>
                <div class="card-tools">
                    <a href="{{ route('training-center-report.create') }}" class="btn btn-sm btn-secondary">
                ...
                @else
                    <form action="{{ route('training-center-report.store') }}" method="POST">
                        ...
                        <div class="mt-4 d-flex flex-column flex-md-row gap-2">
                            ...
                            <a href="{{ route('training-center-report.create') }}" class="btn btn-secondary btn-lg flex-grow-1 flex-md-grow-0" style="min-width: 120px;">
