...
class MemberController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $validated = $request->validate([
            ...
            'picture' => ['nullable', 'image', 'mimes:jpeg,png,jpg,gif', 'max:2048'],
            'citizen_number' => ['nullable', 'string', 'max:50', 'unique:members,citizen_number,' . $id . ',id'],
            'family_card_number' => ['nullable', 'string', 'max:50', 'unique:members,family_card_number,' . $id . ',id'],
            'bpjs_number' => ['nullable', 'string', 'max:50', 'unique:members,bpjs_number,' . $id . ',id'],
            'citizen_img' => ['nullable', 'image', 'mimes:jpeg,png,jpg,gif', 'max:2048'],
            'family_card_img' => ['nullable', 'image', 'mimes:jpeg,png,jpg,gif', 'max:2048'],
            'bpjs_img' => ['nullable', 'image', 'mimes:jpeg,png,jpg,gif', 'max:2048'],
        ]);
